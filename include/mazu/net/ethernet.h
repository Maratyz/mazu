...
#ifndef MAZU_NET_ETHERNET_H
#define MAZU_NET_ETHERNET_H
...
/* This is the data linker layer (layer 2) format. I.e., the one _without_ the
 * preamble, start frame delimiter and Interpacket gap.
 */
...
static inline struct option_u16 ethernet_type_from_netdev_proto(
...
static inline struct option_netdev_proto_t netdev_proto_from_ethernet_type(
    u16 type)
{
    switch (type) {
